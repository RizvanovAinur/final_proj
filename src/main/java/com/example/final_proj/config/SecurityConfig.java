...
public class SecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http//csrf().disable() //отключение защиты от межсайтовой подделки запросов
                ...
                .requestMatchers("/authentication", "/error", "/registration", "/resources/**", "/static/**","/css/**","/logout", "/product", "/img/**", "product/info/**", "/product/search").permitAll() //Всем пользователям доступны страницы атентификации и объект ошибки
